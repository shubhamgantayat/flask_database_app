...
class Operations:
    ...
    def __init__(self, db_name):
        ...
        """
        try:
            self.lg = Logger("mongo_db")
            self.client = pymongo.MongoClient("mongodb+srv://test:test@cluster0.qwvki.mongodb.net/myFirstDatabase?retryWrites=true&w=majority", ssl_cert_reqs=ssl.CERT_NONE)
    ...
    def update(self, table_name, condition, new_val):
        ...
        try:
            table = self.my_db[table_name]
            table.update_many(condition, new_val)
